	        ...
	        if (CodeMirror.modes.hasOwnProperty(mode)) {
	            ...
	            switch (mode) {
	                ...
	                default:
	                    ...
	                    __webpack_require__.e/* require */(1, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [(__webpack_require__(33)("./" + mode + "/" + mode + ".js"))]; (function () {
	                        editor.setOption('mode', mimetype);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(mod) {
	  if (true) // CommonJS
	    mod(__webpack_require__(6), __webpack_require__(29), __webpack_require__(32));
	  else if (typeof define == "function" && define.amd) // AMD
